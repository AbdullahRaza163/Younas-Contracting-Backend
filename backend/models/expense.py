...
class Expense(db.Model):
    ...
    recurrence_start  = db.Column(db.Date, nullable=True)
    ...
    # ── Relationships ─────────────────────────────────────────────
    site = db.relationship('Site', backref='expenses', lazy='joined')

    # A rule → many generated children (cascade delete)
    ...
    def to_dict(self):
        return {
            ...
            'recurrenceStart': self.recurrence_start.isoformat() if self.recurrence_start else None,
            'recurrenceEnd': self.recurrence_end.isoformat() if self.recurrence_end else None,
            'lastGenerated': self.last_generated.isoformat() if self.last_generated else None,
            'parentExpenseId': self.parent_expense_id,
            'isAutoGenerated': self.parent_expense_id is not None,
