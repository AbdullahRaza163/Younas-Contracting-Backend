...
class Worker(db.Model):
    ...
    picture = db.Column(db.Text, nullable=True)  # <-- NEW: base64 data URL or image URL
    ...
    supervised_teams = db.relationship(
        'WorkerTeam',
        backref='supervisor_ref',
        lazy='dynamic',
        foreign_keys='WorkerTeam.supervisor_id'
    )
